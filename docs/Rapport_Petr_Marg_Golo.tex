...
\subsubsection{Mécaniques de gameplay}
\begin{itemize}
\item Filtres pour afficher la quantité de bonheur apportée par case (somme des effets de tous les bâtiments). Permet de savoir quelles sont la zone la plus ou moins heureuse de la ville.
\item Système de quêtes (surtout pour servir comme tutoriel, par exemple: construire 4 maisons, les connecter avec une route : récompense en argent)
\end{itemize}
