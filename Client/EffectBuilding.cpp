...
EffectBuilding::EffectBuilding(QPoint coordinates, int buildingTypeId, int angle) : Building(coordinates, angle)
{
    ...
    //effectId = ConstantBuilding::getEffectId(buildingTypeId);
    //effectRadius = ConstantBuilding::getEffectRadius(buildingTypeId);
    effectBuildingsCount++;
}

EffectBuilding::~EffectBuilding()
{
    effectBuildingsCount--;
}

void EffectBuilding::remove()
{
